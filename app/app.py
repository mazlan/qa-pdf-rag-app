...
from prompt import EXAMPLE_PROMPT, COMBINE_PROMPT
...
def process_file(*, file: AskFileResponse) -> List[Document]:
    ...
    with NamedTemporaryFile(dir='C:\\py_temp_files', delete=False) as tempfile:
...
async def on_chat_start():
    ...
    chain = RetrievalQAWithSourcesChain.from_chain_type(
        llm=model,
        chain_type="stuff",
        retriever=search_engine.as_retriever(max_token_limit=4097),
